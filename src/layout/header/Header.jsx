  ...
  return (
    ...
    <nav className="header__nav-container">
        <ul className="header__nav-links">
            ...
            <li className="header__nav-link"><Link to="/learn">Learn</Link></li>
            <li className="header__nav-link"><Link to="/about">About</Link></li>
            <li className="header__nav-link"><Link to="/gallery">Gallery</Link></li>
            <li className="header__nav-link"><Link to="/contact">Contact</Link></li>
        </ul>
    </nav>
